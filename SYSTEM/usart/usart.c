...
u8 u8Move_Front,u8Move_Back,u8Move_Right,u8Move_Left,u8Move_Pos,u8Move_Neg,u8Move_Zero;

u32 u32Temp;

s16 s16MotorA_Set_Input=0;

s16 s16P_Input,s16I_Input,s16D_Input;

extern short gyro[3], accel[3], sensors;

extern float pitch,roll,yaw;

extern s16 s16MotorA_CtrlOut,s16MotorB_CtrlOut,s16MotorC_CtrlOut;

u8 key_press,wk_press;
//=========================================================
...
//	USART2->CR1|=1<<8;    //PE中断使能(校验错中断)
	...
	MY_NVIC_Init(1,2,USART2_IRQn,3);//组2， 优先级 
//#endif
}
//=========================================================
// UART1 指令回报
...
//				
//=========================================================
void UART1ComReplyTest(u8 SPI2_Recive[16])
{
	USART1_TX_BUF[1]=SPI2_Recive[0];
	USART1_TX_BUF[2]=SPI2_Recive[1];	
	USART1_TX_BUF[3]=SPI2_Recive[2];
	USART1_TX_BUF[4]=SPI2_Recive[3];	
	USART1_TX_BUF[5]=SPI2_Recive[4];

	USART1_TX_BUF[6]=SPI2_Recive[5];
	USART1_TX_BUF[7]=SPI2_Recive[6];	
	USART1_TX_BUF[8]=SPI2_Recive[7];
	USART1_TX_BUF[9]=SPI2_Recive[8];	
	USART1_TX_BUF[10]=SPI2_Recive[9];

	USART1_TX_BUF[11]=SPI2_Recive[10];
	USART1_TX_BUF[12]=SPI2_Recive[11];	
	USART1_TX_BUF[13]=SPI2_Recive[12];
	USART1_TX_BUF[14]=SPI2_Recive[13];	
	USART1_TX_BUF[15]=SPI2_Recive[14];
	
	USART1_TX_BUF[16]=SPI2_Recive[15];
