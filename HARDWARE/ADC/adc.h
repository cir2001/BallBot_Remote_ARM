...
#define CH0_ADC    0 //通道0  右手Y轴
#define CH1_ADC    1 //通道1  右手X轴
#define ADC_CH2    2 //通道2
#define ADC_CH3    3 //通道3	   
#define CH4_ADC    4 //通道4	   
#define CH5_ADC    5 //通道5	   
#define CH6_ADC    6 //通道6	   
#define CH7_ADC    7 //通道7	   
#define CH8_ADC    8 //通道8	  左手Y轴 
#define CH9_ADC    9 //通道9	  左手X轴  
