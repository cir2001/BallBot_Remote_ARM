...
//----PortA----	   	    		 
	...
	GPIOA->CRL&=0XFFF0FFFF; 		//PA4 	推挽复用输出	  		ADC_CH4				A-In(ADC-CH4)		Pin14 
...
//----PortB----	 
	GPIOB->CRL&=0XFFFFFFF0; 		//PB0		模拟输入 			ADC_CH8				A-In(ADC-CH8)		Pin18
	//GPIOB->CRL|=0X00000003;			
	GPIOB->CRL&=0XFFFFFF0F; 		//PB1		模拟输入  			ADC_CH9				A-In(ADC-CH9)		Pin19
...
//-------------
	...
	GPIOB->CRH|=0X00000030; 		//PB9		输入 								SW1						D-In						Pin46
	...
	GPIOB->CRH|=0X00300000; 		//PB13	推挽输出							SPI2-SCK(GT32-SCK)						Pin26
	GPIOB->CRH&=0XF0FFFFFF;														
	GPIOB->CRH|=0X03000000;			//PB14	复用																							Pin27
	GPIOB->CRH&=0X0FFFFFFF;	
	GPIOB->CRH|=0X30000000;			//PB15	推挽输出							SPI2-SDA											Pin28
...
//--------------
	...
	GPIOC->CRH|=0X00300000; 		//PC13	推挽输出													D-Out						Pin2
	GPIOC->CRH&=0XF0FFFFFF;
	GPIOC->CRH|=0X03000000; 		//PC14	推挽输出													D-Out						Pin3
	GPIOC->CRH&=0X0FFFFFFF;
	GPIOC->CRH|=0X30000000; 		//PC15	推挽输出													D-Out						Pin4
